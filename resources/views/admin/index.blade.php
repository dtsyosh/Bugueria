                ...
                <div class="navi">
                    <ul>
                        <li class="active"><a href="#"><i class="fa fa-home" aria-hidden="true"></i><span
                                        class="hidden-xs hidden-sm">Bugueria</span></a></li>
                        <li><a href="/pizzas"><i class="fa fa-tasks" aria-hidden="true"></i><span
                                        class="hidden-xs hidden-sm">Pizzas</span></a></li>
                        <li><a href="/ingredientes"><i class="fa fa-bar-chart" aria-hidden="true"></i><span
                                        class="hidden-xs hidden-sm">Ingredientes</span></a></li>
